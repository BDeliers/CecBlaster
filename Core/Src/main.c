...
static void MX_TIM1_Init(void)
{
  ...
  // TIM1 will be the IR carrier signal outputting PWM @40kHz
...
static void MX_TIM2_Init(void)
{
  ...
  // TIM2 will be a 600µs interrupt signal used to send the IR logical bits
